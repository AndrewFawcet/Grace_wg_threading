...
var makeObject := object {
    method new(value, number, nestedName, nestedIsoName, nestedImmName) -> Object {
        object {
...
var myObject := makeObject.new("Hello Grace!", 42, "Nested Bank Account", "iso Bank Account Object", "imm Bank Account Object")
...
var myObject2 := makeObject.new("Hello Graceeeeeeeeeeee!", 4242, "Another Nested Account", "another iso Bank Account Object" , "another imm Bank Account Object" )

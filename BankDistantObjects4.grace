...
var makeAccount := object {
    method new(accountNameValue, initialBalance) -> Object {
        object {
            ...
            // Leak allowing direct modification of balance from outside
            method leakBalanceModification -> Block {
                { balance.amount := balance.amount + 1000 }  // Directly modify the balance from outside
            }
        }
    }
}
...
// Directly modify balance through leakBalanceModification
var balanceModificationLeak := aliceAccount.leakBalanceModification
balanceModificationLeak.apply  // Directly increments balance by 1000

print "Balance After Leak Modification: {aliceAccount.getBalance} ..."
